...
| **CI green on the Phase 0 PR is unverified until first push** — Done-when 6 / Evidence row 6; the workflow has never run (branch unpushed). | Review round 1 | First push of `phase-0-skeleton`: confirm `ci / lint-test` green, then strike |
