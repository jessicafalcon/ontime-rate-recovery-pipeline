...
Every number here is rendered from `tests/pins.py` and the committed
[docs/RESULTS.md](docs/RESULTS.md) blocks by `make readme` — never typed by hand,
and regenerated byte-identically under `make test`.
