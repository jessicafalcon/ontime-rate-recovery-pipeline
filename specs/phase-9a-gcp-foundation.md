...
7. **Drift to correct at exit — facts.** CLAUDE.md: Repo map `infra/` (real
   ...
   calendar) stay open until 9b. Count 14 → **14** after 9a (one struck, one
   new DUE row from Amendment I).
